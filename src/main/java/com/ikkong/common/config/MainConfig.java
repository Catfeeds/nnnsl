...
import cn.codeforfun.jfinalplugin.quartz.core.QuartzPlugin;
...
import com.ikkong.job.Job1;
import com.ikkong.job.Job2;
...
public class MainConfig extends JFinalConfig implements Const{
	...
	public void configPlugin(Plugins me) {
		...
		quartzPlugin.addJob(new Job1().cron("0 0 0 * * ?"));// 定时任务
		me.add(quartzPlugin);
	}
